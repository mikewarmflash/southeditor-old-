...
function document.onreadystatechange(){
	...
	if (!config.License){
		try{
			eWebEditor_License.innerHTML = "&copy; <a href='./' target='_blank'><font color=#000000>cmbc.nt</font></a>";
		}
		catch(e){
		}
	}
...
//下面的语句支持IE6以上浏览器
    ...
    else{ if (element.YUSERONCLICK) eval(element.YUSERONCLICK + "anonymous()");
    }
